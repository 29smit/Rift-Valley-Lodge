									...
									<div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
										...
										<div class="card">
											...
											<div class="card-body p-12">
												...
												<!--begin::Form-->
												<form  method="post" action="<?php echo base_url(); ?>/update/<?php echo $data[0]['v_id']; ?>" name="myform" id="kt_invoice_form">
													<div class="row">
													...
													<div class="row">
														<div class="col-md-12 text-center">
															...
															<?php if(empty($result))
                                                               {
                                                               echo "<h1>No Amends #1</h1>";
                                                                }
                                                                elseif ($amend ==1 ) 
                                                                {
                                                                	echo"<h1>1 time Amended</h1>";
                                                                }
                                                                else 
                                                                {
                                                                 ?>
                                                                 <h1><?=$amend;?> times Amended</h1>
													...
													<div class="row">
													    ...
													    <?php echo csrf_field(); ?>
                                                         <?php $session = session(); ?>
                                                         <input type="hidden" name="booked_by" value="<?=$data[0]['booked_by']?>">
                                                         <input type="hidden" name="voucher No" value="<?=empty($result) ?1:$data[0]['v_no']?>">
														</div>
														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Full Name</label>
															<input type="text" id="fullname" name="fullname" class="form-control form-control-solid" value="<?=$data[0]['name']?>">
														...
														<div class="col-sm-6 my-2">
 														...
 														<div class="col-sm-6 my-2">
															...
															<input type="text" id="pobox" name="pobox" class="form-control form-control-solid" value="<?=$data[0]['pobox']?>">
															<div class="alert alert-danger pobox-error"></div>
 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Tel.</label>
															<input type="text" id="tel" name="tel" class="form-control form-control-solid" value="<?=$data[0]['tel']?>" >
															<div class="alert alert-danger tel-error"></div>
 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Town.</label>
															<input type="text" id="town" name="town" class="form-control form-control-solid" value="<?=$data[0]['town']?>" >
															<div class="alert alert-danger town-error"></div>
 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Email.</label>
															<input type="text" id="email" name="email" class="form-control form-control-solid" value="<?=$data[0]['email']?>" >
															<div class="alert alert-danger email-error"></div>
 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Arrival date.</label>
															<input type="date" id="arrival_date" name="arrival_date" class="form-control form-control-solid" value="<?php echo date('Y-m-d', strtotime($data[0]['arrival_date']))?>">
															<div class="alert alert-danger arrival-error"></div>

 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Departure date.</label>
															<input type="date" id="dept_date" name="dept_date" class="form-control form-control-solid" value="<?php echo date('Y-m-d', strtotime($data[0]['dept_date']))?>" >
 														...
 														<div class="col-sm-12 my-2">
 															...
 															<table class="table table-row-dashed table-row-gray-300 gy-7">
                                                                ...
                                                                <tbody id="add">
                                                              		...
                                                              		<?php 
                                                                       ...
                                                                       {     
                                                                        ...
                                                                        ?>
                                                                           <tr>
                                                                       	<td>
                                                                            <input type="hidden" name="p_id[]" value="<?php echo $value['pack_id']; ?>">		
															 	        ...
															 	        {
                                                                             ?>	
                                                                                  <option <?php if($room['name']==$value['lodge']){ echo "selected";} ?> ><?php echo $room['name']; ?></option>														 	        	
															 	       <?php }
															 	        ?>
                                                                        </select>
                                                              		</td>
                                                              		<td>
															 	        ...
															 	        {
                                                                             ?>	
                                                                             <option  value="<?php echo $charge['code']; ?>" <?php if($charge['code']==$value['package']){echo"selected";} ?> ><?php echo $charge['member']; ?></option>														 	        	
															 	       <?php }
															 	        ?>
                                                                        </select>
                                                              		</td>
                                                              		<td>
                                                              			 <input type="number" name="pax[]" id="pax1" class="form-control form-control-solid pax validate" value="<?php echo $value['pax']; ?>" onkeyup="count(1,this.value)" onchange="count(1,this.value)" >
                                                              		</td>
                                                              		<td>
                                                              			 <input type="text" value="<?php echo $value['amount']; ?>" name="price[]" class="form-control form-control-solid price validate" id="price1"  readonly>
                                                              		</td>
                                                              		<td>
                                                              			 <input type="text" value="<?php echo $value['total_amount']; ?>"  name="total[]" class="form-control form-control-solid total_val validate" id="total1"  readonly>
                                                              		</td>
                                                              		<td><button class="btn btn-danger cancel" onclick="delete_pack(event,<?php echo $value['pack_id'];  ?>,this)" id="delete">X</button></td>
															...
															<tr>
                                                              		...
                                                              		<td>                                                            
                                                              			<input type="text" value="<?php echo $data[0]['grand_total'] ?>" name="grand_total" class="form-control form-control-solid validate" id="Gt"  readonly></td>
                                                              	</tr>
                                                              	<tr>
                                                              		...
                                                              		<td></td>
                                                              		<td>Discount</td>
                                                              		<td><input type="radio" name="disc"  id="dis_per" <?php if($data[0]['dis_per'] != 0) {echo "checked";} ?> >in percent
                                                              			<input type="text" name="dis_per" class="form-control form-control-solid" id="add_per" value="<?php echo $data[0]['dis_per'] ?>" >
                                                              		<td>                                                            
                                                              			<input type="radio" name="disc"  id="dis_amount" <?php if($data[0]['dis_amount'] != 0) {echo "checked";} ?>>in amount

                                                              			<input type="text" name="dis_amount" class="form-control form-control-solid" id="add_amount" value="<?php echo $data[0]['dis_amount'] ?>" ></td>
                                                              	...
                                                              	<tr>
                                                              		...
                                                              		<td>To be paid</td>
                                                              		<td>                                                            
                                                              			<input type="text" name="pay" class="form-control form-control-solid validate" id="pay" value="<?php echo $data[0]['to_pay'] ?>"  readonly></td>
                                                              	</tr>
                                                        ...
                                                        <div class="col-sm-6 my-2">
															 ...
															 <?php 
															   ...
															   {
															   	 ?>
															   	 <option value="<?php echo $value['mode_code']; ?>" <?php if($data[0]['pay_mode'] == $value['mode_code']){ echo"selected";} ?>><?php  echo $value['modename'] ?></option>
															   <?php }
															 ?>
															 </select>
 														</div>
 														<div class="col-sm-6 my-2">
															...
															<input type="text" id="cheque" name="cheque" class="form-control form-control-solid" value="<?php echo $data[0]['cheque_no']; ?>" 
															readonly>
 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Bank & Branch.</label>
															<input type="text" id="bank" name="bank" class="form-control form-control-solid" value="<?php echo $data[0]['bank']; ?>">
 														</div>
 														<div class="col-sm-6 my-2">
															 <label  class="required form-label">Payment Status.</label>
															<select name="status" id="status" class="form-select form-select-solid" <?php if($data[0]['payment_status']==0) {echo 'style="background:#FF6666;color: #ffffff;"';}else echo 'style="background:#77A977;color: #ffffff;"';?> >
																<option value="0" <?php if($data[0]['payment_status']==0){ echo "selected";} ?> style="background:#FF6666">panding</option>
																<option value="1" <?php if($data[0]['payment_status']==1){ echo "selected";} ?> style="background:#77A977">paid</option>
															</select>
 														</div>
													</div>
													<div class="row">
