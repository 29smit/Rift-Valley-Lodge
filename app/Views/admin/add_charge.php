									...
									<div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
										...
										<div class="card">
											...
											<div class="card-body p-12">
												...
												<!--begin::Form-->
												<form  method="post" action="<?php echo base_url('/create_charge'); ?>" name="myform" id="kt_invoice_form">
													<div class="row">
													...
													<div class="row">
														...
														<div class="col-sm-12 my-2">
															...
															<input type="text" id="desc" name="desc" class="form-control form-control-solid">
